...
static void bishopDanger(int initx, int inity, int finalx, int finaly, Piece ** board) {
...
static void queenDanger(int initx, int inity, int finalx, int finaly, Piece ** board) {
